...
我接触 AI 的起点很实际：为了更高效地完成课程项目与日常开发。我开始尝试氛围式编程（Vibe Coding），也使用过 Claude Code、Codex 等智能体工具。它们让我直观感受到：在需求拆分、代码生成、查错、文档整理和界面打磨上，AI 已经是很有力量的协作者。
...
我喜欢探索还不了解的东西。除了课程和项目，我也会浏览不同地区的产品、技术社区与公共讨论：Instagram、X、WhatsApp、Telegram、Facebook、Discord 等平台对我更像观察窗口——只阅读内容，不发表言论。

日常还会“养” Hermes，让它在一些小实验里多燃一点 token；也会不断试新工具、看新工作流。对我而言，这些并不等于追逐热点，而是希望在快速变化的 AI 时代里，保留观察、提问和亲手验证的习惯。
